...
Marc Brooker is an engineer at AWS and works on agentic AI. He also happens to have a very nice blog and has several blog posts on the topic. I find the one titled *Agentic Software Development Hypothesis*[^2] very relatable. Below is the content of the post, as it is quite short. (I also find the post quite funny. Anyone?)
...
One more thought also crosses my mind: *Bullshit Jobs*.[^5] But I hope not. More on that later.
